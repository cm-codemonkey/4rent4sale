...
class Upload
{
    ...
    private function set_file_name( $argv = null, $name_formation = null ) : string
    {
        switch ( strtoupper($name_formation) )
        {
            ...
            case 'RANDOM':
            /*  */ return (new Security())->randomString(16) .'.'. pathinfo($argv, PATHINFO_EXTENSION); break;

            case 'FILE_NAME_LAST_RANDOM':
            /*  */ return pathinfo($argv, PATHINFO_FILENAME) .'_'. (new Security())->randomString(8) .'.'. pathinfo($argv, PATHINFO_EXTENSION); break;

            case 'FILE_NAME_FIRST_RANDOM':
            /*  */ return (new Security())->randomString(8) .'_'. pathinfo($argv, PATHINFO_FILENAME) .'.'. pathinfo($argv, PATHINFO_EXTENSION); break;
        }
    }
