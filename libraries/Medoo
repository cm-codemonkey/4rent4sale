...
class Medoo
{
	...
	{
		$this->database_type 	= Configuration::$db_type;
		$this->server 			= Configuration::$db_host;
		$this->username 		= Configuration::$db_user;
		$this->password 		= Configuration::$db_pass;
		$this->database_name 	= Configuration::$db_name;
